          ...
          isbutton={
            <div className="card-nav">
              <ul>
                <li
                  className={
                    state.instagramOverviewTabActive === "week"
                      ? "active"
                      : "deactivate"
                  }
                >
                  <Link
                    onClick={() => handleActiveChangeInstagram("week")}
                    // to="#"
                    href="#"
                  >
                    Week
                ...
                <li
                  className={
                    state.instagramOverviewTabActive === "month"
                      ? "active"
                      : "deactivate"
                  }
                >
                  <Link
                    onClick={() => handleActiveChangeInstagram("month")}
                    // to="#"
                    href="#"
                  >
                    Month
                ...
                <li
                  className={
                    state.instagramOverviewTabActive === "year"
                      ? "active"
                      : "deactivate"
                  }
                >
                  <Link
                    onClick={() => handleActiveChangeInstagram("year")}
                    // to="#"
                    href="#"
                  >
                    Year
